...
def actualizar_tipo_operacion(propiedad: Dict) -> Dict:
    ...
    # Si descripción menciona explícitamente RENTA
        ...
        if precio_numeric > 500000:
            logger.info(
                f"⚠️ Precio alto (${precio_numeric:,.0f}) con mención de renta; clasificado como VENTA para evitar falso positivo"
            )
            nuevo_tipo = "venta"
            ...
            logger.info("RENTA detectada por descripción explícita")
